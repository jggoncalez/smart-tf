...
- **Servidores:** Três servidores com funções distintas:
  1. **Servidor DHCP** - Atribuição automática de IPs
  2. **Servidor de Banco de Dados** - Armazenamento dos dados dos semáforos (MongoDB)
  3. **Servidor de Aplicação** - Hospedagem do sistema e do dashboard
